...
const SITE_CONFIG = {
  ...
  pricing: {
    ...
    matrix: [
      { label: "Volume de aulas", values: { start: "Até 40", professional: "Até 40", prime: "Até 60" } },
      { label: "Orientação profissional para gravação", values: { start: true } },
      { label: "2 câmeras", values: { professional: true, prime: true } },
      { label: "Iluminação profissional", values: { professional: true, prime: true } },
      { label: "Microfone profissional", values: { professional: true, prime: true } },
      { label: "Teleprompter", values: { professional: true, prime: true } },
      { label: "Direção durante a gravação", values: { professional: true, prime: true } },
      { label: "Ensaio fotográfico", values: { professional: true, prime: true } },
      { label: "Edição das aulas", values: { start: true, professional: true, prime: true } },
      { label: "Capas das aulas", values: { start: true, professional: true, prime: true } },
      { label: "Estruturação na plataforma", values: { start: true, professional: true, prime: true } },
      { label: "Página de vendas", values: { start: true, professional: true, prime: true } },
      { label: "Apostila / material complementar", values: { prime: true } },
      { label: "Legendas", values: { prime: true } },
      { label: "Vinheta", values: { prime: true } },
      { label: "Site profissional", values: { prime: true } },
      { label: "Entrega em mídia física", values: { prime: true } },
      { label: "Suporte", values: { start: "3 meses", professional: "3 meses", prime: "6 meses" } },
    ],
    volumeNote: {
